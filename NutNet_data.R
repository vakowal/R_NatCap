...
dat_csv <- "C:/Users/Ginger/Dropbox/NatCap_backup/NutNet/NutNet_data_subset_Jan_2018.csv"
...
biomass <- dat[!is.na(dat$mass), c('year', 'site_name',
                                   'site_code', 'block', 'plot', 'subplot.x',
                                   'subplot.y', 'mass', 'live.x', 'live.y',
                                   'category')]
...
biomass <- dat[!is.na(dat$mass), c('year', 'site_code', 'block', 'plot', 'subplot.x',
                                   'subplot.y', 'mass', 'live.x','category')]
