...
# match table: objectid+GEMS station number, groundwater stations
GROUND_OBJECTID_MATCH_CSV <- "F:/NCI_NDR/Data worldbank/station_data/WB_groundwater_stations_noxn_obs_objectid_match.csv"
GROUND_STN_OBJ_MATCH_DF <- read.csv(GROUND_OBJECTID_MATCH_CSV)
...
DELTA_FERTILIZER_1980_2013_BASIN_CSV <- "F:/NCI_NDR/Data fertilizer Lu Tian/perc_change_mean_N_application_1980_2013_basin.csv"
DELTA_FERT_DF <- read.csv(DELTA_FERTILIZER_1980_2013_BASIN_CSV)
...
surface_delta_fert_df <- read.csv("F:/NCI_NDR/Data fertilizer Lu Tian/perc_change_mean_N_application_1980_2013_point_surface.csv")

surface_delta_fert_by_stn <- merge(surface_delta_fert_df, STN_OBJ_MATCH_DF)
fert_app_subset_stn_list <- surface_delta_fert_by_stn[surface_delta_fert_by_stn$perc_change_mean_N_application_1980_2013 <= 172.3,
                                          'GEMS.Station.Number']
...
write.csv(delta_df_to_save, DELTA_FERTILIZER_1980_2013_BASIN_CSV,
          row.names=FALSE)

# change in fertilizer application across years: at pixels containing stations
# from Lu and Tian 2017
fert_by_point_csv_surface <- "F:/NCI_NDR/Data fertilizer Lu Tian/N_by_OBJECTID_WB_surface_stations_noxn_obs_objectid.csv"
fert_by_point_surface <- read.csv(fert_by_point_csv_surface)
start_end_point_surface_df <- fert_by_point_surface[(fert_by_point_surface$year==1980) |
                                                            (fert_by_point_surface$year==2013), ]
delta_1980_2013_point_surface_df <- reshape(start_end_point_surface_df, idvar='OBJECTID',
                                            timevar='year', v.names='fertilizer', direction='wide')
delta_1980_2013_point_surface_df$percent_change <- ((delta_1980_2013_point_surface_df$fertilizer.2013 -
                                                       delta_1980_2013_point_surface_df$fertilizer.1980)/
                                                      delta_1980_2013_point_surface_df$fertilizer.1980) * 100
delta_1980_2013_point_surface_df[!is.na(delta_1980_2013_point_surface_df$fertilizer.1980) &
                                   delta_1980_2013_point_surface_df$fertilizer.1980==0, ]$percent_change <- 100
delta_1980_2013_point_surface_df[is.na(delta_1980_2013_point_surface_df$percent_change), ]$percent_change <- 0
delta_df_to_save <- delta_1980_2013_point_surface_df[, c('OBJECTID', 'percent_change')]
colnames(delta_df_to_save)[2] <- 'perc_change_N_application_1980_2013'
write.csv(delta_df_to_save, "F:/NCI_NDR/Data fertilizer Lu Tian/perc_change_mean_N_application_1980_2013_point_surface.csv")

fert_by_point_csv_ground <- "F:/NCI_NDR/Data fertilizer Lu Tian/N_by_OBJECTID_WB_groundwater_stations_noxn_obs.csv"
fert_by_point_ground <- read.csv(fert_by_point_csv_ground)
start_end_point_ground_df <- fert_by_point_ground[(fert_by_point_ground$year==1980) |
                                                    (fert_by_point_ground$year==2013), ]
delta_1980_2013_point_ground_df <- reshape(start_end_point_ground_df, idvar='OBJECTID',
                                           timevar='year', v.names='fertilizer', direction='wide')
delta_1980_2013_point_ground_df$percent_change <- ((delta_1980_2013_point_ground_df$fertilizer.2013 -
                                                       delta_1980_2013_point_ground_df$fertilizer.1980)/
                                                      delta_1980_2013_point_ground_df$fertilizer.1980) * 100
delta_1980_2013_point_ground_df[!is.na(delta_1980_2013_point_ground_df$fertilizer.1980) &
                                   delta_1980_2013_point_ground_df$fertilizer.1980==0, ]$percent_change <- 100
delta_1980_2013_point_ground_df[is.na(delta_1980_2013_point_ground_df$percent_change), ]$percent_change <- 0
delta_df_to_save <- delta_1980_2013_point_ground_df[, c('OBJECTID', 'percent_change')]
colnames(delta_df_to_save)[2] <- 'perc_change_N_application_1980_2013'
write.csv(delta_df_to_save, "F:/NCI_NDR/Data fertilizer Lu Tian/perc_change_mean_N_application_1980_2013_point_ground.csv")

# how different are surface stations selected on the basis of stability of N application over time,
# when calculated over the basin vs when calculated from the pixel containing the station?
basin_df <- read.csv("F:/NCI_NDR/Data fertilizer Lu Tian/perc_change_mean_N_application_1980_2013_basin.csv")
pixel_df <- read.csv("F:/NCI_NDR/Data fertilizer Lu Tian/perc_change_mean_N_application_1980_2013_point_surface.csv")
stable_stations_basin <- basin_df[basin_df$perc_change_mean_N_application_1980_2013 <= 155.4, 'OBJECTID']
stable_stations_pixel <- pixel_df[pixel_df$perc_change_N_application_1980_2013 <= 172.3, 'OBJECTID']
length(intersect(stable_stations_basin, stable_stations_pixel))
setdiff1 <- setdiff(stable_stations_basin, stable_stations_pixel)
setdiff2 <- setdiff(stable_stations_pixel, stable_stations_basin)
...
# GROUNDWATER
# restrict by stability of N fertilizer application rates
ground_delta_fert_df <- read.csv("F:/NCI_NDR/Data fertilizer Lu Tian/perc_change_mean_N_application_1980_2013_point_ground.csv")

ground_delta_fert_by_stn <- merge(ground_delta_fert_df, GROUND_STN_OBJ_MATCH_DF)
fert_app_subset_stn_list <- ground_delta_fert_by_stn[ground_delta_fert_by_stn$perc_change_mean_N_application_1980_2013 <= 109.4,
                                                      'GEMS.Station.Number']
